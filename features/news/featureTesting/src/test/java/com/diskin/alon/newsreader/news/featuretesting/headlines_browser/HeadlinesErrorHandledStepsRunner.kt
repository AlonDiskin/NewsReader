...
@MediumTest
class HeadlinesErrorHandledStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@handle-headlines-error")
                .scenarios()
    ...
    fun test() {
        ...
        hiltRule.inject()
        start(HeadlinesErrorHandledSteps(newsApi))
    }
}